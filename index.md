...
- [Principal Component Analysis for agricultural study (R).](https://rawcdn.githack.com/dianarociogg/dianarocio.github.io/1a8045d002c101dd813fecc6317b8fd8260bdc2d/ohtml/20180320_ACP_CNA.html)
...
<img src="images/thumbnail_1.jpg?raw=true" width="3">
...
- **Data analysis:**
    - _R programming_ (dplyr, tidiverse, ggplot2, mlr3, sf, RStudio, etc.).
    - _Python_ (NumPy, pandas, matplotlib, scikit-learn, seaborn, PySAL, IPython, Keras, TensorFlow, Transformers, Geopandas, etc.).
    - _SAS_.
